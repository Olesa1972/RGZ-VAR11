...
$result = array_unique($vendors); //3 производителя без повторений
...
foreach($avgrating as $rating){
	...
	echo "<p>".'Производитель: '. htmlspecialchars($vendor)."<br>";
	echo 'Средний рейтинг: '  .htmlspecialchars (number_format($avg,2,',',' '));
}